define({ "api": [
  ...
  },
  {
    ...
    "success": {
      "examples": [
        {
          "title": "Success-Response:",
          "content": "{\n    \"code\": 200,\n    \"data\": {\n        \"admin\": {\n            \"id\": 1,\n            \"name\": \"admin\",\n            \"email\": \"admin@gmail.com\"\n        },\n        \"token\": \"$2y$10$Zh1BUMhWSEK3LQBhLoTo.uQiih9F7mqz0F4kQojIDhTB4KW132Lwy#$2y$10$KUKKyBdb/ph8f2HGk7C7BONdkdIWj7BTBNBka3UK8LnPyPmEW5GOi#$2y$10$t1/aZz5ZLobzb3WFmk3v2Own0ky0A33KojCpdUxwMdlSUPMMxQfrG\",\n        \"metadata\": {}\n    }\n}",
          "type": "json"
        }
      ]
    },
    "filename": "apidoc/AuthAdminMangaApidoc.php",
    "groupTitle": "Auth_Admin_Management",
    "header": {
      "fields": {
        "Header": [
          {
  ...
  {
    "type": "post",
    "url": "/v1/admin/auth/refresh_token",
    "title": "Refresh Admin",
    "version": "0.1.0",
  ...
  {
    "type": "get",
    "url": "/v1/admin/customer/mangas/:mangaId",
    "title": "Get Detail Admin Mangas",
    "version": "0.1.0",
    "name": "GetDetailAdminMangas",
    "group": "Mangas_Admin_Management",
    "success": {
      "examples": [
        {
          "title": "Success-Response:",
    ...
    "filename": "apidoc/MangaAdminApiDoc.php",
    "groupTitle": "Mangas_Admin_Management",
    "header": {
      "fields": {
        "Header": [
          {
  ...
  {
    "type": "get",
    "url": "/v1/admin/customer/mangas",
    "title": "Get List Mangas",
    "version": "0.1.0",
    "name": "GetListAdminMangas",
    "group": "Mangas_Admin_Management",
    "parameter": {
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "type": "String",
            "optional": true,
            "field": "filter[manga_approval_status]",
            "description": "<p>filter by mangas status  WAIT:0, APPROVE:1, NOT:2</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
          ...
          },
          {
            ...
            "type": "String",
            "optional": true,
            "field": "search[users_name]",
            "description": "<p>Search by users_name id</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": true,
            "field": "search[users_id]",
            "description": "<p>Search by users_id id</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": true,
            "field": "search[manga_created_at]",
            "description": "<p>Search by manga_created_at id</p>"
          }
        ]
      }
    },
  ...
  },
  {
    "type": "patch",
    "url": "/v1/admin/customer/mangas/:mangaId",
    "title": "Update Approval Admin Mangas",
    "version": "0.1.0",
    "name": "UpdateApprovalAdminMangas",
    "group": "Mangas_Admin_Management",
    "success": {
      "examples": [
        {
